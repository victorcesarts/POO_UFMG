...
If the ID already exists (the generated ID is already in vector idUsed)
than the function is called recursively until the generated random number
hasn't been used yet. 
The function also has an exception in case someone
try generating a new ID, but all the possible IDs have been already used.
*/
